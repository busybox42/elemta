...
# Script to generate test load for Elemta queue

echo "Generating test load for Elemta queue..."
...
This message was generated by the Elemta test load generator.
"
...
echo "Test load generation complete. Sent ${NUM_MESSAGES} messages."
echo "You can now check the queue using: ./scripts/elemta-cli.sh queue list" 