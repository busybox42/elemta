...
echo "Initializing LDAP users from bootstrap.ldif..."

# Load bootstrap file
ldapadd -x -D "cn=admin,dc=example,dc=com" -w "$LDAP_ADMIN_PASSWORD" -f /docker-entrypoint-initdb.d/bootstrap.ldif || true
